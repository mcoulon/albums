            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
                ...
                <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white rounded-lg">
                    <Link to="add" className="flex items-center p-2">
                        ...
                        <span className="xs:block ml-2">Add Track</span>
                    </Link>
                </button>
            </div>
            <div className="flex-grow flex flex-col min-h-0">
                <DataTable table="tracks" columns={[
                    { label: 'Name', accessor: 'name' },
                    { label: 'Album', accessor: 'album.title' },
                    { label: 'Artist', accessor: 'album.artist.name' },
                    { label: 'Genre', accessor: 'genre.name' },
                ]} />
            </div>
        </div>
    )
